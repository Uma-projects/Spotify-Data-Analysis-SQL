...
![Spotify Logo](https://raw.githubusercontent.com/Uma-projects/Spotify-Data-Analysis-SQL/refs/heads/main/spotify_logo.png)
...
``` sql
SELECT COUNT(track) AS total_no_track ,artist
...
```
2. Find tracks where the energy-to-liveness ratio is greater than 1.2.
``` sql
